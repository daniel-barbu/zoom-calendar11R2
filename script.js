...
if (typeof idTable[day] == "undefined" || typeof idTable[day][hour] == "undefined")
  ...
  document.getElementById("hourProgress").innerHTML="|" + "-".repeat(perc*(70+(0.5-perc)*15) + "<span id='whiteText'>|</span>" + "-".repeat((1-perc)*(70+(0.5-perc)*15) + "|<br>" + hStart[hour] + " <span id='invisibleText'>"+ ".".repeat(perc*72) + "</span> <span id='whiteText'>" + hNow + "</span> <span id='invisibleText'>"+ ".".repeat((1-perc)*72) + "</span> " + hEnd[hour];
