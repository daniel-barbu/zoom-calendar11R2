...
if (typeof idTable[day] == "undefined" || typeof idTable[day][hour] == "undefined")
  ...
  document.getElementById("hourProgress").innerHTML="|" + "-".repeat(perc*(70+(0.5-perc)*25)) + "<span id='whiteText'>|</span>" + "-".repeat((1-perc)*(70+(0.5-perc)*25)) + "|<br>" + hStart[hour] + "<span id='invisibleText'>" + "-".repeat(perc*(70+(0.5-perc)*25)) + "</span><span id='whiteText'>" + hNow + "</span><span id='invisibleText'>"+ "-".repeat((1-perc)*(70+(0.5-perc)*25)) + "</span>" + hEnd[hour];
